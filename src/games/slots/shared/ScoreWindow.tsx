...
import { balance, bet } from "../../../assets/slot/info";
...
const SlotScoreWindow: FC<IScoreWindowProps> = ({ children, icon }) => {
  return (
    <div className="relative font-sans text-[35px]">
      ...
      >
        <path
          d="M8.03888 2.88379C4.17528 2.88379 1.31879 6.48215 2.19533 10.245L7.14767 31.5046C7.2174 31.8039 7.2172 32.1153 7.1471 32.4145L2.20361 53.5152C1.32159 57.2799 4.17871 60.8838 8.04544 60.8838H243.789C246.187 60.8838 248.354 59.4565 249.301 57.2539L259.16 34.3265C259.809 32.8174 259.811 31.1082 259.165 29.5978L249.3 6.52511C248.356 4.31642 246.186 2.88379 243.783 2.88379H8.03888Z"
          fill="#2E1D33"
          stroke="url(#paint0_linear_228_3497)"
          stroke-width="4"
        />
        <defs>
          <linearGradient
            id="paint0_linear_228_3497"
            x1="130.5"
            y1="4.88379"
            x2="130.5"
            y2="58.8838"
      ...
      >
        {icon === "balance" && <img src={balance} />}
        {icon === "bets" && <img src={bet} />}
      </div>
    </div>
  );
};
